...
`adaptive-subagent-orchestrator-dev`는 복잡한 소프트웨어 엔지니어링 요청을 독립 작업 흐름으로 나눌 수 있는지 판단하고, 병렬 위임 이점이 분명할 때만 최소한의 서브에이전트를 조율하는 플러그인입니다.
...
- `$adaptive-subagent-orchestrator-dev:adaptive-subagent-orchestrator`
