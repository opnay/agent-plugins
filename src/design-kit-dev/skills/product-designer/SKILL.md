...
Read `$design-kit-dev:project-design-rules/references/project-context.md`, `$design-kit-dev:design-base/references/interaction-content.md`, `$design-kit-dev:design-base/references/space-type-surface.md`, and `$design-kit-dev:design-base/references/repetition.md`.

Read `$design-kit-dev:design-base/references/color.md` when choosing palettes or semantic and data colors. No planner or foundation skill must run first; use supplied requirements and inspect missing task-relevant context directly.
