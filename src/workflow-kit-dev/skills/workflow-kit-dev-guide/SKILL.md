---
name: workflow-kit-dev-guide
description: Default first-read skill for incoming requests. Use to choose which `workflow-kit-dev` skill should own the current workflow and what handoff order should follow.
---
...
Use this skill as the default entrypoint for `workflow-kit-dev`.
...
Skip this guide only when a narrower `workflow-kit-dev` skill is already clearly the right starting point.
