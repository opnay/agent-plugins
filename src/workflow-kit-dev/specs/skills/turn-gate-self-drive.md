...
base loop, flow record, Continuity Guard, next-flow reopening은 `turn-gate`가 소유하고, 이 skill은 bounded decision을 subagent question packet으로 라우팅하는 계약을 소유합니다.
...
- 대표 표면: `workflow-kit-dev/skills/turn-gate-self-drive/SKILL.md`
- base skill: `workflow-kit-dev/skills/turn-gate/SKILL.md`
