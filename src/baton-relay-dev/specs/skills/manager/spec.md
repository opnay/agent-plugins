...
- `decomposition.md`: orchestration fit, no-use/no-spawn, workstream/write scope/dependency/parallel blockers/acceptance 기준, 병렬/순차 판단을 소유합니다.
- `lifecycle.md`: dispatch packet과 subagent 작업 사이클을 소유합니다.
- `handoff.md`: commit/rebase handoff gate, prepared commit 회수, integration verification, cleanup을 소유합니다.
