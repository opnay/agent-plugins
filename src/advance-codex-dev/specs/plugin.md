...
- 포함:
  ...
  - UI, UX, interface content, color, tone/expression, branding, surface/form, product quality 중심의 product design judgment
...
- 화면, user flow, interface content, color, tone/expression, branding, surface/form, product quality에서 디자인 판단 기준을 명시하는 작업
...
- `pro-designer`: 화면과 제품 UI 작업에서 UI, UX, Content, Color, Tone & Expression, Branding, Surface & Form, Quality 축의 디자인 판단 기준을 제공한다.
