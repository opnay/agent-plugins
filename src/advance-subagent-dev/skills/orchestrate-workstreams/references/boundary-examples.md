...
Explicit subagent 요청은 자동 trigger 제외 사례도 gate에 진입시킬 수 있지만, skill 경계를 넓히거나 spawn을 보장하지 않습니다. 같은 플러그인의 `deep-research`는 pure research의 참고 경계이며 runtime prerequisite가 아닙니다.
