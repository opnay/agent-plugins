...
<!--
File name: {count-pad3}-{eng-lower-slug}.md
Location: .agents/sessions/{YYYYMMDD}/{count-pad3}-{eng-lower-slug}.md
Example: 001-flow-template-specs.md
Create a new file when the active flow boundary changes.
-->
...
- handoff: `{handoff-condition-or-next-intake-condition}`
