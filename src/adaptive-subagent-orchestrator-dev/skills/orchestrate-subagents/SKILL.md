...
Then use `$adaptive-subagent-orchestrator-dev:dispatch-subagents`. Preserve the original request and explicit constraints; do not pre-decide mode, ownership, role, or agent count.
