...
- 대표 runtime 표면: `advance-codex-dev/skills/pro-planner/SKILL.md`
- 사용자 스펙 의도: `advance-codex-dev/specs/skills/pro-planner/intent.md`
- skill spec index: `advance-codex-dev/specs/skills/pro-planner/spec.md`
- sub-spec directory: `advance-codex-dev/specs/skills/pro-planner/core/`
...
다른 `advance-codex` skill과 함께 쓰일 수는 있지만, 제품과 기능 정의 판단 자체는 이 skill 본문만으로 수행 가능해야 합니다.
...
- release build 후 root `advance-codex/skills/pro-planner/SKILL.md`가 존재해야 한다.
