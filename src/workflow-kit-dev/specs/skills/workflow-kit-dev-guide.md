...
# workflow-kit-dev-guide 스킬 스펙

## 목적

`workflow-kit-dev-guide`는 들어온 요청의 현재 bottleneck을 기준으로 어떤 workflow skill이 시작점이 되어야 하는지 결정하는 global first-read router입니다.
...
- 대표 표면: `workflow-kit-dev/skills/workflow-kit-dev-guide/SKILL.md`
