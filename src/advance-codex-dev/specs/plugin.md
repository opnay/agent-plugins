...
핵심 책임은 skill, plugin bundle, skill scenario testing, change finalization, product planning judgment, engineering judgment 같은 Codex 활용 산출물을 각각의 좁은 skill 표면으로 제공하는 것입니다.
...
- `pro-planner`: 제품, 서비스, 기능 정의에서 사용자 문제, 가치, 범위, 요구사항, 우선순위, acceptance criteria, handoff 계약을 제공한다.
  - spec: `advance-codex-dev/specs/skills/pro-planner/spec.md`
