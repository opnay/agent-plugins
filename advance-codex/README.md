...
재사용 가능한 skill, installable plugin bundle, change finalization, reusable instruction evaluation, problem-solving-centered engineering judgment 같은 Codex 활용 체계를 설계하고 정리하는 작업을 위한 문서화와 가이드를 제공합니다.
...
`pro-designer`는 화면, user flow, interface content, color/tone, surface/form, product quality를 UI, UX, Content, Color, Surface & Form, Quality 축으로 판단해야 할 때 사용합니다.
