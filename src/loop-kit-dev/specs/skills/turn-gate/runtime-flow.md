...
- canonical phase label은 `preparation`, `work`, `verification`, `reporting`, `continuation`을 사용합니다.
- 예: `[preparation]`, `[work]`, `[verification]`, `[reporting]`, `[continuation]`
...
- phase 세부 계약이 `phase-preparation.md`, `phase-work.md`, `phase-verification.md`, `phase-reporting.md`로 위임되는가?
