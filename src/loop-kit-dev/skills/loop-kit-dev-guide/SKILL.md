---
name: loop-kit-dev-guide
description: Entrypoint skill for `loop-kit-dev`. Use it to decide whether the task should start in the narrow turn-continuity package and, if so, route into `turn-gate`.
---
...
- Do not hide a broader workflow-selection problem inside `loop-kit-dev`.
