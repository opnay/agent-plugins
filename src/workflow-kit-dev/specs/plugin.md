...
핵심 책임은 sequential analysis, planning, execution, refinement, review, final gating을 각각의 workflow skill로 제공하는 것입니다.
...
- `deep-interview`는 `loop-kit-dev`가 소유합니다. workflow-kit은 요구사항 인터뷰 skill을 직접 노출하지 않습니다.
