...
For repetition-related patterns, read `$design-kit-dev:design-base/references/repetition.md`. Record context, repeated elements, preserved meaning and role, and conditions for omission, reintroduction, emphasis, or variation. Cover terms, colors, motifs, form, layout, and interaction as relevant, not only repeated copy.
